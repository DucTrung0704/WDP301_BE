      ...
      schemas: {
        ...
        MissionResponse: {
          ...
          properties: {
            ...
            createdBy: { type: "string", example: "507f1f77bcf86cd799439011", description: "ObjectId of the creator" },
            createdAt: { type: "string", format: "date-time" },
            updatedAt: { type: "string", format: "date-time" },
          },
        },
        ...
        MissionPlanResponse: {
          ...
          properties: {
            _id: { type: "string", example: "507f1f77bcf86cd799439011" },
            mission: { type: "string", example: "507f1f77bcf86cd799439011" },
            flightPlan: { $ref: "#/components/schemas/FlightPlanBriefResponse" },
